...
router.register(r'users/groups', UserGroupViewSet, basename='groups')
...
urlpatterns = [
    ...
    path('users/list/', UserListOnly.as_view(), name='users-list'),
    ...
    # path('users/role-list', UserRoleList.as_view(), name='roles'),
